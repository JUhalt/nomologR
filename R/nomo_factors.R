...
#' *Psychometrika, 19*(2), 149-161. \doi{10.1007/BF02289162}
#'
...
#'
#' Achim, A. (2017). Testing the number of required dimensions in exploratory
#' factor analysis. *The Quantitative Methods for Psychology, 13*(1), 64-74.
...
#' Measurement, 70*(6), 885-901. \doi{10.1177/0013164410379332}
#'
...
#' Research, 46*(2), 340-364. \doi{10.1080/00273171.2011.564527}
#'
...
#' (pp. 41-71). Springer. \doi{10.1007/978-1-4615-4397-8_3}
#'
...
#' 39*(1), 31-36. \doi{10.1007/BF02291575}
#'
#' @examples
