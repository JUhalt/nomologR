...
- **Completed:** learning foundations (#25) and readable invariance labels
  ...
  basis article; maintenance (#36).
- **Core, in progress or next:** research basis methods registry (#26), model
  comparison with `nomo_compare()` (#27), auditable revision lineage (#28),
  bifactor and higher-order models (#29), replication-status language (#30),
