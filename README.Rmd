...
The [`v0.2.1` milestone](https://github.com/JUhalt/nomologR/milestone/4) holds
six workstreams moved out of `v0.2.0` at certification, each with its reason
recorded: missing-data sensitivity (#32), score guidance (#33),
...
that release (for example IRT/DIF, Bayesian SEM, ESEM, longitudinal
