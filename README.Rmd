...
`v0.2.0` makes the workflow research-backed from historical to contemporary
...
The [`v0.2.1` milestone](https://github.com/JUhalt/nomologR/milestone/4) began
with six workstreams moved out of `v0.2.0` at certification. In the development
version so far:
...
With missing-data sensitivity in place, every `v0.2.1` workstream is in the
development version.

### Next: `v0.3.0` and `v1.0.0`

`v0.3.0` carries the first CRAN submission
([#39](https://github.com/JUhalt/nomologR/issues/39)) and a reader for handoffs
from `contentvalidR` ([#46](https://github.com/JUhalt/nomologR/issues/46)), so
items that passed content review can be screened and modeled here. Other
candidates for that release (for example IRT/DIF, Bayesian SEM, ESEM, and
