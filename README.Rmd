...
- **Completed:** learning foundations (#25) and readable invariance labels
  ...
  registry with `nomo_methods()` (#26); and interval-based replication-status
  language for sign changes (#30).
- **Core, in progress or next:** bifactor and higher-order models (#29) and
  release certification with a CRAN-readiness gate (#37).
