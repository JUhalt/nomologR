...
**Current stable release: `0.1.0` — the first public release of `nomologR`. See the roadmap for planned `v0.2.x` development.**
...
`v0.1.0` is the first stable public release. Planned `v0.2.x` work focuses on robustness and broader measurement models.
