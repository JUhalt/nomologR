...
- [`nomo_screen()`](https://juhalt.github.io/nomologR/reference/nomo_screen.md)
  and
  [`nomo_run()`](https://juhalt.github.io/nomologR/reference/nomo_run.md)
  accept a handoff from `contentvalidR`, so items that passed content
  review are screened and modeled here, with the reasons for each
  held-back item quoted in the log
...
[`nomo_scores()`](https://juhalt.github.io/nomologR/reference/nomo_scores.md)
(#33), careless-responding indices (#34), factor determinacy and
construct replicability (#56), disclosure of relationships estimated
between observed variables (#62), a parallel reliability bootstrap
(#42),
[`nomo_apa_table()`](https://juhalt.github.io/nomologR/reference/nomo_apa_table.md)
and Word reports (#35),
[`nomo_missing()`](https://juhalt.github.io/nomologR/reference/nomo_missing.md)
(#32), and reports rendered from inside R Markdown and Quarto documents
(#40).
