...
#>  6 parall… fact… Commo… contem… prim… Number … Reference … nomo_factors() psych 
#>  7 map_or… fact… Velic… contem… supp… Factor … Component-… nomo_factors() nomol…
#>  8 map_re… fact… Velic… contem… supp… Factor … As for ori… nomo_factors() nomol…
#>  9 ekc     fact… Empir… contem… supp… Factor … Derived fo… nomo_factors() EFAto…
#> 10 nest    fact… Next … emergi… supp… Sequent… Resampling… nomo_factors() EFAto…
#> # ℹ 55 more rows
...
#> 12 Standardized loadings and average variance extracted supporting Convergent e…
#> 13 Fornell-Larcker comparison                           context    Simulation w…
#> 14 Fixed change-in-CFI rule                             context    Derived unde…
#> 15 Nomological network of construct relations           primary    Evidence for…
